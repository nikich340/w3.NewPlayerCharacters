...
class NR_CBTTaskMagicMeteorFallAttack extends CBTTaskAttack
{
	...
	latent function ShootMeteor() : bool {
		...
		meteor.projDMG = NR_GetDamageGeneric( "NR_CBTTaskMagicMeteorFallAttack", /*caster*/ GetNPC(), /*target*/ enemies[index], /*min*/ 20.f, /*max*/ 40.f, /*vitality*/ 8.f, 25.f, /*essence*/ 90.f, 12.f);
